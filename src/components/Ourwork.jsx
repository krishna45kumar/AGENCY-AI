...
const Ourwork = () => {
  ...
  return (
   ...
   <Title  title='Our latest work'  desc='From strategy to ecacution , we craft digital solution that move your business forward.'/>
