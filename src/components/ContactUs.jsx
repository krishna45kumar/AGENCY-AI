...
const ContactUs = () => {
 ...
 const onSubmit = async(event)=>{
    ...
    formData.append("access_key", "c90ed5d8-2aca-451e-a923-c382a8137582");
    ...
    if (data.success) {
       toast.success('thanku you for your submission')
      event.target.reset();
    } else {
      ...
      onSubmit={onSubmit} className='grid sm:grid-cols-2 sm:gap-5 max-w-2xl w-full'>
        ...
        <div>
            ...
            <div className='flex pl-3 rounded-lg border border-gray-300 dark:border-gray-600'>
                 ...
                 <input  name="name" type="text" placeholder='Enter your name' className='w-full p-3 text-sm 
        ...
        <div className='sm:col-span-2'>
            ...
            <textarea name="message"  rows={8} placeholder='Enter your message' className='w-full p-3 text-sm outline-none rounde-lg border border-gray-300 dark:border-gray-600' required />
        </div>
