    ...
    <motion.div 
     ...
     className='flex  justify-between items-center px-4 sm:px-12 lg:px-24 xl:px-40 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-900/70 '> 
      ...
      <ThemeToggleBtn theme={theme} setTheme={setTheme}/>
        ...
        <a href ="#contact-us" className='text-sm max-sm:hidden flex items-center gap-2 m-2 bg-primary text-white px-6 py-3 rounded-full cursor-pointer hover:scale-103 transition-all'>Connect
